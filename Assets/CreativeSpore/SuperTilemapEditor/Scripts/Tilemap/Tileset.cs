...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    {
        public IList<int> tileIds { get { return m_tileIds != null ? m_tileIds.AsReadOnly() : null; } }
        ...
        public TileSelection(List<int> tileIds, int rowLength)
        {
            m_tileIds = tileIds != null ? tileIds : new List<int>();
            m_rowLength = Mathf.Max(1, rowLength);
        }

        public TileSelection Clone()
        {
            List<int> tileIds = new List<int>(m_tileIds);
        ...
        {
            List<int> flipedTileIds = new List<int>();
    ...
    public class Tileset : ScriptableObject
    {
        ...
        public TileSelection TileSelection
        {
            get
            {
                m_tileSelection = (m_tileSelection != null && m_tileSelection.tileIds != null && m_tileSelection.tileIds.Count > 0) ? m_tileSelection : null; //NOTE: sometimes m_tileSelection.tileIds has no tiles, even with the "set" check
                return m_tileSelection;
            }
            set
            {
                TileSelection prevValue = m_tileSelection;
                m_tileSelection = (value != null && value.tileIds != null && value.tileIds.Count > 0) ? value : null;
        ...
        public TilesetBrush FindBrush(int id)
        {
            return m_brushes.FirstOrDefault(x => x.Id == id).BrushAsset;
        }
