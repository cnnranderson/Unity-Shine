...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public class Tilemap : MonoBehaviour
    {
        ...
        /// </summary>
        public float InnerPadding = 0.5f;
        /// <summary>
        ...
        public int SortingLayerID
        {
            ...
            set
            {
                ...
                for (int i = 0; i < transform.childCount; ++i)
                {
                    ...
                    if (chunk != null)
                    {
                        chunk.SortingLayerID = value;
                        m_sortingLayerName = chunk.SortingLayerName;
                    }
                }
            }
        }
        ...
        public string SortingLayerName
        {
            ...
            set
            {
                ...
                for (int i = 0; i < transform.childCount; ++i)
                {
                    ...
                    if (chunk != null)
                    {
                        chunk.SortingLayerName = value;
                        m_sortingLayer = chunk.SortingLayerID;
                    }
                }
            }
        }
        ...
        void _DoDuplicate()
        {
            m_material = new Material(m_material.shader);
        ...
        void OnDrawGizmosSelected()
        {
            ...
            if ( ShowGrid && Selection.activeGameObject == this.gameObject)
            {
